...
struct GridPosition: Hashable, Equatable {
    ...
    static func + (lhs: GridPosition, rhs: ZenArcadeDirection) -> GridPosition {
        GridPosition(row: lhs.row + rhs.dRow, col: lhs.col + rhs.dCol)
    }
}

enum ZenArcadeDirection: CaseIterable {
    ...
    var opposite: ZenArcadeDirection {
        switch self {
...
struct PlacedWord {
    ...
    let direction: ZenArcadeDirection
...
struct WordSearchGrid {
    ...
    private mutating func placeWord(_ word: String, rng: inout SeededRandomGenerator) {
        ...
        var directions = ZenArcadeDirection.allCases
    ...
    private func canPlace(word: String, at start: GridPosition, direction: ZenArcadeDirection) -> Bool {
        var pos = start
        for char in word {
    ...
    private mutating func place(word: String, at start: GridPosition, direction: ZenArcadeDirection) {
        var pos = start
        for char in word {
